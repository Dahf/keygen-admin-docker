...
hummingbird.get(
  ...
  controllers.products.handle_delete
);
hummingbird.get(
  "/product/:product_id/policies/create",
  controllers.policies.create
);
hummingbird.post(
  "/product/:product_id/policies/create",
  controllers.policies.handle_create
);
hummingbird.get(
  "/product/:product_id/policy/:policy_id/delete",
  controllers.policies.handle_delete
);
hummingbird.get(
  "/product/:product_id/licenses/create",
  controllers.licenses.create
);
hummingbird.post(
  "/product/:product_id/licenses/create",
  controllers.licenses.handle_create
);
hummingbird.get("/license/:license_id", controllers.licenses.show);
hummingbird.get(
  "/license/:license_id/delete",
  controllers.licenses.handle_delete
);
